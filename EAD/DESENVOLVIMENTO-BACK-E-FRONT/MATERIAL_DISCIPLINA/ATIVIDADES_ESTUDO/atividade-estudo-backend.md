...
**Tipo:** Atividade de Estudo Simplificada
...
## Etapa 5 — Teste com Thunder Client ou curl

Teste cada rota usando o Thunder Client (extensão do VS Code) ou curl:
...
- [ ] Testes realizados com curl ou Thunder Client;
